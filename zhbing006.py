...
# # cursor.execute('insert into person (id,name,phone_num) values (%s,%s,%s)',['001','abc','13000001111'])
# # cursor.execute('insert into person (id,name,phone_num) values (%s,%s,%s)',['002','def','13011223344'])
# # cursor.execute("UPDATE person SET phone_num='13012345678',name='zb' WHERE id='001'")
